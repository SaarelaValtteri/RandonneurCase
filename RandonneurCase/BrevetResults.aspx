    ...
    <form id="form1" runat="server">
        <div id="div_CONTAINER">
            ...
            <div id="div_CENTER">
             ...
             <asp:Label ID="lbDistance" runat="server">Distance</asp:Label>.<br />

              <asp:DropDownList ID="ddlDistance" runat="server">
            </asp:DropDownList><br />

            <asp:Label ID="lbYear" runat="server">Date</asp:Label>. <br />

            <asp:DropDownList ID="ddlYear" runat="server">
            </asp:DropDownList><br />

            <asp:Label ID="lbLocation" runat="server">Location</asp:Label>.
            ...
            <asp:Button ID="btSearch" runat="server" Text="Search Brevets" OnClick="btSearch_Click" />
            </div>
