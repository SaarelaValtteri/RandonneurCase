           ...
           <div id="div_RIGHT">
                ...
                <div id="div_right_DETAILS">
                    ...
                    <div class="div_right_details_ROW">
                        <asp:Label ID="lbClubId" runat="server" Text="ClubId:" CssClass="detail_label"></asp:Label>
                   ...
                   <div class="div_right_details_ROW">
                        ...
                        <asp:TextBox ID="tbCity" runat="server" CssClass="detail_textbox" MaxLength="50"></asp:TextBox>
